...
class Products(Base):
    ...
    currency: Mapped[CurrencyEnum] = mapped_column(
        sa.Enum(CurrencyEnum, native_enum=True, create_type=True, name="currency_enum"), nullable=False
    )
...
class Orders(Base):
    ...
    status: Mapped[OrderStatusEnum] = mapped_column(
        sa.Enum(OrderStatusEnum, native_enum=True, create_type=True, name="order_status_enum"), nullable=False
    )
    created_at: Mapped[datetime] = mapped_column(sa.DateTime, server_default=sa.func.now(), nullable=False)
    updated_at: Mapped[datetime] = mapped_column(
        sa.DateTime, server_default=sa.func.now(), onupdate=sa.func.now(), nullable=False
